...
export default function Verify2FA() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] px-4">
      <div className="w-full max-w-md p-10 bg-slate-900 border border-slate-800 rounded-[2.5rem] shadow-2xl">
        <div className="absolute top-0 left-0 w-32 h-32 bg-blue-600/10 blur-3xl rounded-full -translate-x-1/2 -translate-y-1/2"></div>

        <h2 className="text-3xl font-black text-center text-white italic uppercase tracking-tighter mb-3">
          Verificación en<br />
